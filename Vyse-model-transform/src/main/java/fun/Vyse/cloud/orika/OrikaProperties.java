...
public class OrikaProperties {
     ...
     * (MapperFactoryBuilder#useBuiltinConverters(boolean)). Follows Orika's
     * behavior by default.
     */
    ...
    /**
     * Whether to map null values (MapperFactoryBuilder#mapNulls(boolean)). Follows
     * Orika's behavior by default.
     */
    private Boolean mapNulls;

    /**
     * Whether to dump the current state of the mapping infrastructure objects upon
     * occurrence of an exception while mapping
     * (MapperFactoryBuilder#dumpStateOnException(boolean)). Follows Orika's
     * behavior by default.
     */
     ...
     * (MapperFactoryBuilder#favorExtension(boolean)). Follows Orika's behavior by
     * default.
     */
     ...
     * (MapperFactoryBuilder#captureFieldContext(boolean)). Follows Orika's behavior
     * by default.
     */
