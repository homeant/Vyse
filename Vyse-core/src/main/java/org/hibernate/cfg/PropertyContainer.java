...
public class PropertyContainer {
	...
	public Collection<XProperty> getProperties() {
		...
		List<XProperty> values = this.persistentAttributeMap.values().stream().collect(Collectors.toList());
//		Collections.sort(values, (o1, o2) -> {
//			ColumnMeta meat1 = o1.getAnnotation(ColumnMeta.class);
//			ColumnMeta meta2 = o2.getAnnotation(ColumnMeta.class);
//			int index1 = 0;
//			int index2 = 0;
//			if (meat1 != null) {
//				index1 = meat1.index();
